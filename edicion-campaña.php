...
<head>
    ...
    <script>
        <?php require "php/conecta.php";
            ...
            $sql="SELECT * FROM campañas WHERE id='$identificador'";
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <form id="formulario" name="formulario" enctype="multipart/form-data">
                                ...
                                <label>Campaña:</label>
                                <input type="text" class="form-control" name="campaña" value="<?= $row['nombre'] ?>">

                                <label>Fecha de inicio:</label>
                                <input type="date" class="form-control" name="inicio" value="<?= $row['fechaInicio'] ?>">
                                <label>Fecha de finalización:</label>
                                <input type="date" class="form-control" name="fin" value="<?= $row['fechaFin'] ?>">
