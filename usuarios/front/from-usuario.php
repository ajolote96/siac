            ...
            <div class="col-lg-12 text-center">
                ...
                <form id="formulario" name="formulario" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="RPE" placeholder="Ingrese un RPE">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="CAC" placeholder="Ingrese un Centro de atencion a cliente">
                    </div>
