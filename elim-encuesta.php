                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <form id="formulario" name="formulario" enctype="multipart/form-data">
                                <h1>Deseas Eliminar este registro?</h1>
                                <label>Identificador:</label>
                                <input type="number" class="form-control" name="id" readonly value="<?= $row['id'] ?>">

                                <label>Campaña:</label>
                                <input type="text" class="form-control" name="campaña" readonly value="<?= $row['campaña'] ?>">

                                <label>Pregunta:</label>
                                <input type="text" class="form-control" name="preguntas" readonly value="<?= $row['preguntas'] ?>">
                                <br>
